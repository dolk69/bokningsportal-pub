...
export const getBookingObjects = async () => {
  ...
  return booking_objects.map((obj) => ({
    ...
    bookingConfirmationMessage: obj.booking_confirmation_message || "",
    priceMonday: toKr(obj.price_monday_cents ?? obj.price_weekday_cents),
    priceTuesday: toKr(obj.price_tuesday_cents ?? obj.price_weekday_cents),
    priceWednesday: toKr(obj.price_wednesday_cents ?? obj.price_weekday_cents),
    priceThursday: toKr(obj.price_thursday_cents ?? obj.price_weekday_cents),
    priceFriday: toKr(obj.price_friday_cents ?? obj.price_weekday_cents),
    priceSaturday: toKr(obj.price_saturday_cents ?? obj.price_weekend_cents),
    priceSunday: toKr(obj.price_sunday_cents ?? obj.price_weekend_cents),
...
export const createBookingObject = (payload) =>
  apiRequest("/admin/booking-objects", {
    ...
    body: JSON.stringify({
      ...
      booking_confirmation_message: String(payload.bookingConfirmationMessage || "").trim(),
      price_weekday_cents: toCents(payload.priceMonday),
      price_weekend_cents: toCents(payload.priceSaturday),
      price_monday_cents: toCents(payload.priceMonday),
      price_tuesday_cents: toCents(payload.priceTuesday),
      price_wednesday_cents: toCents(payload.priceWednesday),
      price_thursday_cents: toCents(payload.priceThursday),
      price_friday_cents: toCents(payload.priceFriday),
      price_saturday_cents: toCents(payload.priceSaturday),
      price_sunday_cents: toCents(payload.priceSunday),
